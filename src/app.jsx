      ...
      <Card className="expenses-results-card">
        <div className="result result-premium">
          <div className="result-info">
            <span className="result-icon"><ReceiptIndianRupee size={19} /></span>
            <div>
              <small>EXPENSE OVERVIEW</small>
              <span>Showing <b>{filtered.length}</b> {filtered.length === 1 ? 'record' : 'records'}</span>
            </div>
          </div>
