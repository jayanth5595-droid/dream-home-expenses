...
function DashboardView({ total, expenses, category, member, owner, setAuth, setTab }) {
  ...
  return (
    <>
      <Head title="Dashboard" sub="A beautiful view of your Dream Home finances."
      ...
      <section className="dream-hero">
        <div className="dream-hero-copy">
          <span className="hero-kicker">YOUR DREAM HOME</span>
          <h2>Building memories,<br />one expense at a time.</h2>
          <p>Track every family contribution and watch your dream home take shape.</p>
        </div>
        <div className="hero-house-art" aria-hidden="true">
          <div className="art-sun" />
          <div className="art-house">
            <div className="art-roof" />
            <div className="art-floor art-floor-top"><i /><i /></div>
            <div className="art-floor art-floor-bottom"><i /><i /></div>
            <div className="art-door" />
          </div>
          <div className="art-tree art-tree-one"><b /><i /><i /><i /></div>
          <div className="art-tree art-tree-two"><b /><i /><i /><i /></div>
        </div>

        <div className="investment-card">
          <div className="investment-main">
            <div className="investment-icon"><House size={25} /></div>
            <div>
          ...
          <div className="investment-stats">
            <div><span className="stat-icon"><Receipt size={17} /></span><b>{expenses.length}</b><small>Expenses</small></div>
            <div><span className="stat-icon"><Blocks size={17} /></span><b>{category.length}</b><small>Categories</small></div>
            <div><span className="stat-icon"><UsersIcon size={17} /></span><b>{member.length}</b><small>Contributors</small></div>
          </div>
        </div>
        <div className="dream-quote">Small steps<br /><span>Big dreams</span></div>
      </section>
      ...
      <Card title="Recent Expenses" subtitle="Your latest home expenses"
