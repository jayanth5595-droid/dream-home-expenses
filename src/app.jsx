...
/* Premium vector category icon system. Database emojis are ignored so every
   category gets a consistent, crisp Lucide icon. */
const categoryIconMap = {
  materials: Blocks, material: Blocks,
  labour: HardHat, labor: HardHat,
...
const categoryAccentMap = {
  materials: 'blue', material: 'blue',
  labour: 'green', labor: 'green',
              ...
              <tr key={x.id}>
                ...
                <td>
                  <span className="category-chip">
                    <CategoryIcon category={x.category} size={16} />
